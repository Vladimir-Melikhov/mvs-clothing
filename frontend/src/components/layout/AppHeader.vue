<template>
    <nav 
      ...
      :class="variant === 'dark' ? 'bg-black/90 border-white/10' : scrolled ? 'bg-black/90 border-white/10' : 'bg-white/90 border-gray-200'" 
    ...
    >
      <div class="max-w-7xl mx-auto px-6 py-5">
        <div class="flex items-center justify-between">
          ...
          <div 
            ...
            :class="variant === 'dark' ? 'text-white' : scrolled ? 'text-white' : 'text-black'"
          >
      ...
      <div 
        ...
        :class="variant === 'dark' ? 'bg-black/95 border-white/10 text-white' : scrolled ? 'bg-black/95 border-white/10 text-white' : 'bg-white border-gray-200 text-black'"
      >
        <div class="px-6 py-6 space-y-6 text-xs tracking-[0.2em]">
          ...
          <div 
            ...
            :class="variant === 'dark' ? 'border-white/10' : scrolled ? 'border-white/10' : 'border-gray-200'"
          >
            <router-link 
